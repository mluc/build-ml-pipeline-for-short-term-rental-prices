...
def go(args):
    ...
    run_name = f"train_random_forest_{uuid.uuid4().hex[:8]}"
    logger.info(f"Running train_random_forest with run_name: {run_name}")
    run = wandb.init(job_type="train_random_forest", name=run_name)
